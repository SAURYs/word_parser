...
class format(QWidget):
    ...
    def format_widget(self,list=[],alignenable=0,beforeenable=0,afterenable=0,leftenable=0,rightenable=0):
        ...
        cb_fontsize.addItems(["五号","小五","四号","小四","三号","小三","二号","小二","小初","初号"])
...
class check_box(QWidget):
    ...
    def check_widget(self):
        ...
        pic_continuous = QCheckBox("检测图表标题连续性")
        pic_continuous.setChecked(False)
        pic_continuous.setEnabled(False)
        ...
        table_title = QCheckBox("检测表格标题格式       ")
        ...
        appendix_continuous.setChecked(False)
        appendix_continuous.setEnabled(False)
        references_continuous = QCheckBox("检测参考文献顺序连续性")
        references_continuous.setChecked(False)
        references_continuous.setEnabled(False)
