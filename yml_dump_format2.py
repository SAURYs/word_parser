...
class format_new(QWidget):
    ...
    def format_new_widget(self,alignenable=1,beforeenable=1,afterenable=1,leftenable=1,rightenable=1,save=0):
        ...
        self.cb_fontsize.addItems(["五号","小五","四号","小四","三号","小三","二号","小二","小初","初号"])
...
class check_box_new(QWidget):
    ...
    def check_widget(self):
        ...
        self.pic_continuous.setChecked(False)
        self.pic_continuous.setEnabled(False)
        ...
        self.table_title = QCheckBox("检测表格标题格式     ")
        ...
        self.appendix_continuous.setChecked(False)
        self.appendix_continuous.setEnabled(False)
        self.references_continuous = QCheckBox("检测参考文献顺序连续性")
        self.references_continuous.setChecked(False)
        self.references_continuous.setEnabled(False)
